...
def infer(args):
    ...
    with init_ctx:
        ...
        model = MODEL_CLS.from_pretrained(args.model, torch_dtype=TORCH_DTYPE_MAP.get(args.dtype, None))
    ...
    out = engine.generate(prompts=[args.prompt, args.prompt, args.prompt, args.prompt], generation_config=generation_config)
